...
const translations = {
  fr: {
    titleAdd: 'Ajouter un châssis',
    titleEdit: 'Modifier le châssis',
    type: 'Type de châssis',
    repere: 'Repère',
    largeur: 'Largeur (mm)',
    hauteur: 'Hauteur (mm)',
    etat: 'État',
  ...
  it: {
    titleAdd: 'Aggiungi telaio',
    titleEdit: 'Modifica telaio',
    type: 'Tipo telaio',
    repere: 'Repere',
    largeur: 'Larghezza (mm)',
    hauteur: 'Altezza (mm)',
    etat: 'Stato',
    cancel: 'Annulla',
    create: 'Crea',
  ...
  en: {
    titleAdd: 'Add Chassis',
    titleEdit: 'Edit Chassis',
    type: 'Chassis Type',
    repere: 'ID / Repère',
    largeur: 'Width (mm)',
    hauteur: 'Height (mm)',
...
function ChassisForm({ language, chassis, projectId, onClose, onSave }) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal large" onClick={e => e.stopPropagation()}>
        <h2>{isEdit ? t.titleEdit : t.titleAdd}</h2>
